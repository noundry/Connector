...
using Noundry.EnterpriseApiClient.Samples.JSONPlaceholder;

namespace Noundry.EnterpriseApiClient.Tests.Integration;
...
public class ReadmeExampleTests
{
    ...
    public void QuickStartExample_CompileAndConfigureSuccessfully()
    {
        ...
        services.AddEnterpriseApiClient<IJsonPlaceholderApi>(options =>
        {
    ...
    public async Task JsonPlaceholderIntegration_WorksAsDocumentedInReadme()
    {
        ...
        {
            options.BaseUrl = "https://jsonplaceholder.typicode.com";
            options.DefaultHeaders["User-Agent"] = "Noundry.EnterpriseApiClient.Tests/1.0.0";
        });
